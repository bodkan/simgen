---
title: "Introduction to _slendr_"
subtitle: "A crash course for the workshop on 'Simulation-Based Population Genomics and Inference in R'"
format:
  revealjs:                     ### slides
    echo: true                  ### slides
...
<center>![](slendr_files/images/fstats_sims.png)</center>
...
<center>![](slendr_files/images/admixture.png)</center>
...
<center>![](slendr_files/images/abc_scheme.png){width="50%"}</center>
...
<center>![](slendr_files/images/mcmc.png)</center>
...
![<small>Image modified from [Alexei Drummond</small>](http://alexeidrummond.org/bayesian_phylo_lectures/lecture10/)](slendr_files/images/sim_sketches.001.png){width="100%"}
...
![](slendr_files/images/slendr_logo.png){width="30%"}
...
<center>![](slendr_files/images/animation.gif){width="70%"}</center>
...
![](slendr_files/images/tree_sequence_diagram_no_muts.png){width="80%" fig-align="center"}
...
<center>![](slendr_files/images/vcf_screenshot.png){width="90%"}</center>
...
<center>![](slendr_files/images/tree_sequence_diagram_no_muts.png)</center>
...
![](slendr_files/images/tree_sequence_diagram_no_muts.png)
...
![](slendr_files/images/tree_sequence_diagram.png)
...
<center>![](slendr_files/images/slendr_tskit.png)</center>
...
![](slendr_files/images/tables.jpeg)
...
<center>![](slendr_files/images/tree_diagram.png)</center>
...
Each exercise corresponds to a chapter of my [WIP "workbook"](https://bodkan.net/simgen/).
...
These slides are available at [this link](https://bodkan.quarto.pub/),
also as a single document (easy to use as a reference "cheat sheet").
...
Each exercise is split into individual Parts, intended to be solved one
after the other (each task **highlighted in bold**).
...
You will be coding complete simulations from scratch! If you ever get lost at some
task, just take a peek at my solution.
:::
...
Building a demographic model with _slendr_, scheduling sampling events, and
simulating tree sequences.

<br>

Find the exercise [here](https://bodkan.net/simgen/slendr-models.html).

## Exercise 2

<br>

Computing population genetic statistics on tree sequences simulated with _slendr_.

<br>

Find the exercise [here](https://bodkan.net/simgen/popgen-stats.html).

## Exercise 3

<br>

Building a simulation-based inference pipeline of $N_e$ from an allele
frequency spectrum from scratch.

<br>

Find the exercise [here](https://bodkan.net/simgen/inference-afs.html).

## Exercise 4

<br>

Simulating a selection sweep by extending a base _slendr_ model with a
selection scenario implemented in SLiM.

<br>

Find the exercise [here](https://bodkan.net/simgen/popgen-selection.html).

## That's it!

A couple of additional links about _slendr_:

- [_slendr_ website](https://www.slendr.net) (documentation, tutorials, etc.)
- [GitHub repository](https://github.com/bodkan/slendr) (bug reports please!)
- [_slendr_ paper](https://peercommunityjournal.org/articles/10.24072/pcjournal.354/) (please cite me :))

<br>

My new R package for simulation-based inference [_demografr_](https://github.com/bodkan/demografr)!
