...
Even scalars (i.e., singular values) are formally vectors!
...
are converted by a straightforward cascade of so-called "coercions".

**Try to figure out some of these coercion rules based on different composition
of value types you put into the `c()` vector constructing function?**
