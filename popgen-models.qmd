...
which we discussed in ["Introduction to _slendr"_](https://bodkan.net/simgen/handouts_slendr.html),
...
## Part 6: More complex sampling events
...
## Part 7: Simulating a defined set of individuals
