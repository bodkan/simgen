...
conform to Wright-Fisher assumptions. The simplification of assuming
no overlapping generations will be particularly important here.

As in all other exercises in this course, the exercise in this chapter is
divided into individual Parts. To make the text a little easier to digest
and orient yourself in, a concrete, specific task of each Part is emphasized
**in bold**.
