...
![](popgen_files/images/intro_model1.png){width="50%"}
...
model <- read_model(here::here("popgen_files/introgression"))
ts <- ts_read(here::here(file = "popgen_files/introgression.trees"), model = model)
...
#| echo: false
model <- read_model(here::here("popgen_files/introgression"))
ts <- ts_read(file = here::here("popgen_files/introgression.trees"), model = model)
```
