...
### Exercise 3: Limiting axis scales
...
Just try running these two examples on your own, and see what happens!
We'll be using `ggsave()` a lot in the next session!**

**Note:** Take a peek at `?ggsave` help page to see customization options.
Also, we're saving a PDF here. How would you create a PNG images
with the figures?


### Exercise 4: Relationship between two variables
...
### Exercise 5: Multiple data sets in one plot
...
### Exercise 6: Categories in facets (panels)
