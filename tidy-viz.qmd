...
## Exercise 4: Merging metadata

After basic processing and filtering of the primary data (in our case, the
coordinates of pairwise IBD segments), we often need to annotate our popgen
data with some metadata information. What does this mean? Consider our IBD
