...
<!-- Quarto wouldn't show the code by default because it doesn't produce any -->
<!-- results, but let's show it to our audience for completeness -->
<!-- (These are HTML comments by the way, and can be sometimes helpful.) -->
...
## Take a glance at the first couple of values
...
## Summary of the statistical fits
...
## Summary of the fit of the direct $f_4$-ratio statistic
...
## Summary of the fit of the indirect $f_4$-ratio statistic
