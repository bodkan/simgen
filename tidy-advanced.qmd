...
between long and wide table formats -- [link](https://r4ds.hadley.nz/data-tidy.html).
...
data scientist should be familiar with -- [link](https://r4ds.hadley.nz/regexps.html)
