...
## R provides awesome tools for reproducibility
...
but try to internalize the keyboard shortcuts which I
<span style="background-color: #FFFF00">highlighted in yellow</span> in there.
...
<center>![](files/whoami/slendr_help.png){width="52%"}</center>
