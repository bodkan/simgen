...
chapters in form of handouts, as well as the slides themselves. These are
intended for easier reference during practical exercise sessions for each
relevant chapter.
...
## One-page slides handouts

- **"R bootcamp"** -- [link](https://bodkan.net/simgen/handouts_r-bootcamp.html)
- **"Introduction to _tidyverse_"** -- [link](https://bodkan.net/simgen/handouts_tidy-basics.html)
- **"Visualization with _ggplot2_"** -- [link](https://bodkan.net/simgen/handouts_tidy-viz.html)
- **"Simulations with _slendr_"** -- [link](https://bodkan.net/simgen/handouts_slendr.html)

## Slides

- **R bootcamp** -- [link](slides_r-bootcamp.html)

- **Introduction to _tidyverse_** --- [link](slides_tidy-basics.html)

- **Visualization with _ggplot2_** --- [link](slides_tidy-viz.html)

- **Simulations with _slendr_** -- [link](slides_slendr.html)
