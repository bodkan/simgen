...
- **R bootcamp** -- [slides](slides_r-bootcamp.html)

- **Introduction to _tidyverse_** --- [slides](slides_tidy-basics.html)

- **Visualization with _ggplot2_** --- [slides](slides_tidy-viz.html)

- **Simulations with _slendr_** -- [slides](slides_slendr.html)
