...
<h1>A couple of examples of these patterns on simulated data</h1>

<br><h2>(tree sequence `ts` we got from `msprime()` above)</h2>
...
<!-- - Check out my new package [_demografr_](http://github.com/bodkan/demografr) -->

<!--   - It builds on _slendr_! -->
...
<!-- A quick "the best of..." tour of _slendr_ features: -->

<!-- 1. **Building a demographic model** and simulating genomic data from it -->

<!-- 2. Using _slendr_ as a sandbox for **exploring population genetic statistics** -->

<!-- 3. An example of **simulation-based inference** (a toy ABC-like inference procedure) -->

<!-- 4. **Simulating natural selection with _slendr_** -->
