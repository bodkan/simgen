...
results to third-party software.
...
These slides are available at [this link](https://bodkan.quarto.pub/slendr-intro-handouts/)
as a single document, easy to use as a reference "cheat sheet".
