...
# for (n in c(50, 25, 10, 5, 2, 1)) {
  ...
  ts_eigenstrat(ts, "data/spatial_pca")

  plot_pca("data/spatial_pca", ts, model = "map", color_by = "pop") 
...
read_ind(eigenstrat("data/spatial_pca"))

ts_samples(ts)

plot_pca("data/spatial_pca", ts, model = "map", color = "pop")
```
