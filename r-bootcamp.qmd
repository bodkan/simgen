...
**In this first chapter, you will be exploring the basics of the R language.
...
to a set of very simple principles and components. The purpose of this
chapter is to introduce you to these fundamentals.**
...
**Every time you encounter a new bit of code, looking like this:**
...
**please copy it into your script. You can then put your cursor at the beginning
of that code chunk, and hit `CTRL + Enter` (on Windows/Linux) or `CMD + Enter`
(on macOS) to execute it. Alternatively, you can also type it out to the R
...
The `w1 <- 3.14` operation can be read as _"assign the value"_. I.e.,
_"assign the value 3.14 to a variable `w1`"_
...
data types using `typeof()` again, just like you did for "single-value
