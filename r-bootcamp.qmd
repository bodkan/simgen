...
A custom function in R is defined by the following pattern. Note that
...
Custom functions can take several form, most importantly:
...
named `values` (the vector of numbers), and return a list which combines all the six summary statistics
...
**Then test that your function works correctly by running it:**
