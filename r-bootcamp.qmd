...
You might first have to install the packages _palmerpenguins_:
...
relationship between those two variables / columns: `penguins$flipper_length_mm`
against `penguins$body_mass_g`. Is there an indication of a relationship between
the two metrics?**
