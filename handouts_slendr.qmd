...
2. Start with the chapter on _"Demographic models"_
- Theme: building demographic models in _slendr_
3. When you're done, continue with _"Tree-sequence statistics"_
- Theme: computing population genetic statistics with _slendr_
