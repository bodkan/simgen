...
A single command, very little typing, and immediately readable, almost like 
English: _"filter data frame `df` for individuals in which column `groupAge`
is "Archaic", and who are older than 50000 years"_. When you think about it,
it's pretty much impossible to find a solution requiring less code.
