...
- **"Data visualization"** -- [cheatsheet on the **_ggplot2_** package](cheatsheets/ggplot2.pdf)
...
- **"Welcome to _tidyverse_"** -- [one-page handouts](https://bodkan.net/simgen/handouts_tidy.html)
- **"Introduction to _slendr_"** -- [one-page handouts](https://bodkan.net/simgen/handouts_slendr.html)