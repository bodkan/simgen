...
subtitle: "A quick crash course for the workshop on 'Simulation-Based Population Genomics and Inference in R'"
author:
  - "Martin Petr"
format:
#  revealjs:                     ### slides
...
<h1>A couple of examples on simulated data</h1>

<br><h2>(tree sequence `ts` we got from `msprime()` earlier)</h2>
...
**Note:** This is quite a signification simplification of the entire picture.
...
Tree sequence is an incredibly useful data structure, but there's a whole world
of well-established bioinformatics tools 
...
Each of the following exercises contains a link to a chapter of my WIP workbook.


## Exercise 1

Building a demographic model with _slendr_: [link](https://bodkan.net/simgen/slendr-models.html)

## Exercise 2

Computing tree-sequence statistics: [link](https://bodkan.net/simgen/slendr-models.html)

## Exercise 3

Simulation-based inference of $N_e$ from scratch: [link](https://bodkan.net/simgen/inference-afs.html)


## Exercise 4

Extending _slendr_ models towards non-neutral simulations: [link](https://bodkan.net/simgen/popgen-selection.html)
