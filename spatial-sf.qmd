...
This load the following functions:
...
visualization features. Don't take any of the IBD results as conclusive in
any way!**</u> :)
...
effectively turns the IBD table into a spatial table, because after this
...
care of thinking put into it. It will be polished eventually.)
...
sf_ibd <- relocate(sf_ibd, sample1, sample2, total_ibd, time_bin1, time_bin2, country1, country2, link)
```
...
The time bin **(4000,5000]** is very cool I think! Yamnaya moving out! :)
...
Again, the time bin **(4000,5000]** consistent with [this study](https://english.elpais.com/elpais/2018/10/03/inenglish/1538568010_930565.html)?
