...
fundamentals of population genomics and statistical inference in R, with a strong
...
involve a set of inter-linked tutorials together with worksheets containing
practical exercises (and solutions).

Ultimately, the workbook will provide resources which will become the basis of
two weeks long course on population genomics and statistical inference using
computer simulations, largely revolving around R packages [_slendr_](https://github.com/bodkan/demografr) and
[_demografr_](https://github.com/bodkan/demografr). While introducing the
fundamentals of population genomics, it will also frame the material
...
[_renv_](https://rstudio.github.io/renv/)), as well as a selection of R packages
from the [_tidyverse_](https://www.tidyverse.org) data science toolkit.
