...
research (such as [_git_](https://git-scm.com) and [_renv_](https://rstudio.github.io/renv/)), as well as demonstrate the most useful
applications of a selection of R packages from the
[_tidyverse_](https://www.tidyverse.org) data science toolkit.
